...
const EMAIL_LOGO_HEADER = `<div style="text-align:center;margin-bottom:32px;padding-bottom:24px;border-bottom:2px solid #E2E8F0;"><img src="https://biomathcore.com/logo-header.webp" alt="BioMath Core" style="height:64px;width:64px;margin-bottom:12px;"/><div style="font-size:28px;font-weight:700;"><span style="color:#2563EB;">BioMath</span> <span style="color:#0B0F19;">Core</span></div></div>`;
